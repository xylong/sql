...
func newUserProfile(db *gorm.DB, opts ...gen.DOOption) userProfile {
	...
	_userProfile.Gender = field.NewInt64(tableName, "gender")
	_userProfile.Level = field.NewInt64(tableName, "level")
	_userProfile.Password = field.NewString(tableName, "password")
	_userProfile.Salt = field.NewString(tableName, "salt")
...
type userProfile struct {
	...
	Gender    field.Int64  // 性别：0保密 1 男 2女 3未知
